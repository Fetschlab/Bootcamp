...
% (On your own, can check out any number of video tutorials online)
...
% Our logistic model is nice but merely descriptive. It makes no claim 
% how the decision occurs. Next we can introduce a mechanistic or 'process'
...
%%
% although still rather abstracted away from real neurons,
% SDT was among the first generative/process models for perception that
% could be  translated into a so-called 'linking hypothesis';
% this was arguably the genesis of (sensory) systems neuroscience
% (BACK TO SLIDES)
...
% See Shadlen et al. 2006 if you want the nitty gritty.
